...
const pages = [

    {
        ...
        id: 'dashboard',
        icon: '🏠',
        funkcja: "Wyświetla karty przedmiotów i humorystycznie poprzez emoji informuje o ilości zaliczonych zadań przez ucznia na danym przedmiocie. Uczeń aby zdać do następnej klasy musi mieć zaliczone co najmniej 50% zadań z każdego przedmiotu. Druga sekcja jest to nawigacja do strony z egzaminem próbnym dla obowiązujących kwalifikacji czyli INF.02 i INF.03. //TODO Strona egzaminacyjne do zrealizowania w próżniejszym terminie"
    },
    {
        name: 'Zadania',
        id: 'tasks',
